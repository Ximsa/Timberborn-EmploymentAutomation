...
namespace EmploymentAutomation.UI
{
    ...
    {
        protected override EmploymentManagerPanel BuilderInstance => this;
    }

    public abstract class EmploymentManagerPanel<TBuilder> : BaseBuilder<TBuilder, NineSliceVisualElement>
